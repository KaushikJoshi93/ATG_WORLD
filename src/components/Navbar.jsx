        ...
        <nav className="p-0 md:p-3 w-full absolute md:static z-50 top-0  ">
            <div className="w-full justify-between items-center hidden md:flex">
                ...
                <div className="d-flex relative ">
                    ...
                    <input type="text" className="pl-8 bg-gray-200 p-2 rounded-full w-[320px]" placeholder="Search for your favorite groups in ATG" aria-label="Username" aria-describedby="addon-wrapping" />
                </div>
                {/* dropdown */}
                <div className="flex ">
                    Create Account.
                    ...
                    </p>
                    {
                        dropdownClick && createPortal(
                            <div className='absolute top-0 w-full h-screen bg-[#000000b8] flex justify-normal items-end md:justify-center md:items-center z-[999]'>
                                <div className='bg-white w-full md:w-fit h-[70%] md:h-[80%] rounded-t-2xl md:rounded-2xl relative'>
                                    <div className='absolute top-0 md:top-[-45px] right-4 md:right-0 text-black md:text-white cursor-pointer' onClick={() => setDropDownClick(false)}>
